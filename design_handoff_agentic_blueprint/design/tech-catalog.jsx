// Tech catalog — pros / cons / best-for for the technologies referenced in
// COMP_ENRICHMENT. Keys are normalized (lowercase, alphanumeric only) so we
// can match flexible labels like "Anthropic MCP (reference)" → "anthropicmcp".

const TECH_CATALOG_RAW = {
  // ── Chat & UI frameworks ──────────────────────────────────────
  "Vercel AI SDK": {
    ...
    license: "Apache 2.0", maturity: "Production",
  },
  "Microsoft Copilot Studio": {
    ...
    license: "Commercial", maturity: "Production",
  },
  ...
  "Custom React + SSE": {
    ...
    license: "Your code", maturity: "Forever",
  },
  ...
  "OpenAI Realtime API": {
    ...
    license: "Commercial", maturity: "GA",
  },
  "Deepgram + ElevenLabs": {
  ...
  "Whisper + Coqui TTS": {
    ...
    license: "MIT / MPL-2.0", maturity: "Mature",
  },
  "LiveKit Agents": {
  ...
  "Keycloak": {
    ...
    license: "Apache 2.0", maturity: "Mature",
  },
  "AWS Cognito": {
  ...
  "Passkeys (WebAuthn)": {
    ...
    license: "W3C Standard", maturity: "GA",
  },
  ...
  "HashiCorp Vault": {
    ...
    license: "BUSL 1.1 (was MPL)", maturity: "GA",
  },
  "AWS STS AssumeRole": {
  ...
  "AWS Cedar": {
    ...
    license: "Apache 2.0", maturity: "GA",
  },
  "Oso": {
    ...
    license: "Commercial / Apache 2.0 (oss)", maturity: "Production",
  },
  ...
  "LangGraph": {
    ...
    license: "MIT", maturity: "Production",
  },
  "AutoGen": {
  ...
  "OpenAI Swarm": {
    ...
    license: "MIT", maturity: "Experimental",
  },
  ...
  "Anthropic SKILL.md (Claude Skills)": {
    ...
    license: "Open spec", maturity: "Active",
  },
  "Mem0": {
    ...
    license: "Apache 2.0", maturity: "Active",
  },
  "Letta (MemGPT)": {
  ...
  "Portkey": {
    ...
    license: "MIT (oss core) / Commercial", maturity: "Production",
  },
  "Helicone": {
  ...
  "Anthropic MCP Servers": {
    ...
    license: "MIT (spec / SDKs)", maturity: "Active",
  },
  "Cloudflare MCP": {
    ...
    license: "Commercial / OSS", maturity: "Active",
  },
  "Anthropic Computer Use": {
    ...
    license: "Commercial", maturity: "Beta",
  },
  "Browserbase": {
  ...
  "E2B": {
    ...
    license: "Apache 2.0 / Commercial", maturity: "Production",
  },
  ...
  "Weaviate": {
    ...
    license: "BSD-3-Clause", maturity: "Production",
  },
  "Qdrant": {
  ...
  "pgvector (Postgres)": {
    ...
    license: "PostgreSQL License", maturity: "Production",
  },
  "Cohere Rerank": {
  ...
  "Inngest": {
    ...
    license: "Apache 2.0 (oss) / Commercial", maturity: "Production",
  },
  ...
  "Arize Phoenix": {
    ...
    license: "Elastic / OSS", maturity: "Production",
  },
  "Braintrust": {
  ...
  "Llama Guard 3 (Meta)": {
    ...
    license: "Llama 3 Community License", maturity: "Production",
  },
  "Anthropic Constitutional Classifiers": {
    ...
    license: "Commercial", maturity: "Active",
  },
  "Lakera Guard": {
...
// Build a normalized lookup so flexible labels still match.
const norm = (s) => s.toLowerCase().replace(/[^a-z0-9]/g, "");
const TECH_CATALOG = {};
Object.entries(TECH_CATALOG_RAW).forEach(([k, v]) => {
  TECH_CATALOG[norm(k)] = { name: k, ...v };
});

window.TECH_CATALOG = TECH_CATALOG;
window.lookupTech = (label) => {
  if (!label) return null;
  const n = norm(label);
  // exact match
  if (TECH_CATALOG[n]) return TECH_CATALOG[n];
  // try first comma- / parenthesis-stripped fragment
  const stripped = label.replace(/\(.*?\)/g, "").split(/[,/]/)[0].trim();
  const n2 = norm(stripped);
  if (TECH_CATALOG[n2]) return TECH_CATALOG[n2];
  // try matching by prefix (Vault → HashiCorp Vault)
  const keys = Object.keys(TECH_CATALOG);
  const hit = keys.find(k => k.includes(n2) || n2.includes(k));
  return hit ? TECH_CATALOG[hit] : null;
};
