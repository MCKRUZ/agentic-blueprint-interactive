...
export const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    tagline: "The enterprise truth the platform serves",
    ink: "var(--ink-l11)",
    exec: "The authoritative data systems that existed before the AI platform and will outlive it. Agents read from and write back to these carefully — they are the ground truth the enterprise trusts.",
    eng: "Enterprise backend systems. The platform integrates via the Tool & Integration Surface but treats these as canonical. Writes require explicit governance approval. Conflict resolution defers to MDM.",
    components: [
      {
        id: "crm",
        name: "CRM & Customer Data",
        exec: "The canonical customer record — contacts, accounts, opportunities, interaction history. Salesforce, Dynamics 365, HubSpot.",
        eng: "Salesforce / Dynamics 365 / HubSpot. Agents read via API Hub, write-back gated by autonomy tier. Conflict resolution: CRM wins.",
        terms: ["Salesforce", "Dynamics 365", "HubSpot"],
      },
      {
        id: "erp",
        name: "ERP & Operations",
        exec: "Financial ledgers, supply chain, procurement — the numbers the CFO signs off on. SAP, Oracle, NetSuite.",
        eng: "SAP S/4HANA, Oracle Fusion, NetSuite. Write operations require human-in-the-loop for anything above threshold. Double-entry integrity enforced.",
        terms: ["SAP", "Oracle", "NetSuite"],
      },
      {
        id: "hris",
        name: "Identity & HR Systems",
        exec: "Org chart, roles, compensation, permissions — who is who in the enterprise. Workday, SuccessFactors.",
        eng: "Workday, SuccessFactors, BambooHR. Read-heavy for org context. Write restricted to approved HR workflows. PII handling per GDPR/CCPA.",
        terms: ["Workday", "SuccessFactors", "HRIS"],
      },
      {
        id: "itsm",
        name: "Service Management",
        exec: "Tickets, incidents, change records, SLAs — the process truth. ServiceNow, Jira Service Management.",
        eng: "ServiceNow / Jira SM. Agents create and update tickets autonomously within governance bounds. Change records require CAB approval signal.",
        terms: ["ServiceNow", "Jira", "ITSM", "CAB"],
      },
      {
        id: "data-platform",
        name: "Data Platform",
        exec: "Warehouse, lakehouse, ETL pipelines — the analytical layer everyone reports from. Snowflake, Databricks, Fabric.",
        eng: "Snowflake, Databricks, Microsoft Fabric. Read for analytics and grounding. Write for agent-generated insights. Governed by data mesh ownership.",
        terms: ["Snowflake", "Databricks", "Fabric", "Data Mesh"],
      },
      {
        id: "mdm",
        name: "Master Data Management",
        exec: "Entity resolution and golden records — the arbiter when sources disagree about the same customer, product, or location.",
        eng: "Informatica MDM, Reltio, Profisee. Cross-system entity resolution. Golden record is authoritative. Agents must reconcile against MDM before asserting entity facts.",
        terms: ["MDM", "Golden Record", "Entity Resolution"],
      },
    ],
  },
];
